...
<script src="assets/js/custom_js/do_demo_exam.js"></script>
<script src="module/ckeditor/ckeditor.js"></script>

<!-- countdown control section-->
<script>
    if(sessionStorage.getItem('demo_exam_data')==undefined){
        window.location.href = "./main";
    }
    var exam_data_key = sessionStorage.getItem('demo_exam_data');
