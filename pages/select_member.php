...
<div class="page-wrapper">
  <div class="content-wrapper">
    <?php
      ...
      $member_data = load_user($class_id,$filter);
...
<script>
  function cb_depart_changed(value){
    if(value == 0){
      window.location.href = "template?page=classroom&sub_page=select_member<?= $class_id_param.$class_des_param?>";
    }else{
      window.location.href = "template?page=classroom&sub_page=select_member<?= $class_id_param.$class_des_param?>&dep_id="+value;
    }
  }
  function cb_unit_changed(value){
    ...
    if(data[0]==0){
      if(<?=$dep_id?>==0){
        ...
        window.location.href = "template?page=classroom&sub_page=select_member<?= $class_id_param.$class_des_param?>&dep_id="+'<?=$dep_id?>';
      }
    }else{
      window.location.href = "template?page=classroom&sub_page=select_member<?= $class_id_param.$class_des_param?>&dep_id="+data[0]+"&unit_id="+data[1];
    }
  }
