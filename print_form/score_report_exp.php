...
<link rel="stylesheet" href="forexport/bootstrap.min.css">
<script src="forexport/jquery-1.11.3.min.js"></script>
<script src="forexport/bootstrap.min.js"></script>
<script src='forexport/excelexportjs.js'></script>
  
</head>

<body>
    <div class="content" id= "tableData">
        <div class="body-content">
            <div class="table-content">
                <table>
					<tr>
                        <th class="phetsarath f16 b center" colspan="9">ໃບປະເມີນວິຊາການ</th>
                    </tr>
					<tr>
                        <td class="phetsarath f12" colspan="9">ນະຄອນຫຼວງວຽງຈັນ, ວັນທີ: <?=date('d/m/Y')?></br>
						ສູນຝຶກອົບຮົມ</b>, ຝ່າຍຈັດຕັ້ງ ແລະ ບໍລິຫານ ຂໍຖືເປັນກຽດ <?=$has_data?$print_data['doc_des']:''?> ດັ່ງລາຍລະອຽດລຸ່ມນີ້:
						</th>
                    </tr>
                    <tr>
                        <th class="phetsarath f12 b center" width="45">ລ/ດ</th>
                        <th class="phetsarath f12 b center">ລະຫັດພ/ງ</th>
                        <th class="phetsarath f12 b center">ຊື່ ແລະ ນາມສະກຸນ</th>
                        <th class="phetsarath f12 b center">ລະດັບວິຊາສະເພາະ</th>
                        ...
                        <th class="phetsarath f12 b center">ໝາຍເຫດ</th>
                    </tr>
                    <?php
                        if($has_data){
...
<div align="center" style="margin-top: -10px;">
	<button id="DLtoExcel" name="btn_exp" class="btn-newclass btn btn-primary btn-icon-text none-select none-outline phetsarath">
