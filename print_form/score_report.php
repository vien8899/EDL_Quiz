...
if(isset($_POST['data'])){
    ...
    $print_data['exam_date'] = $_POST['exam_date'];
    $print_data['doc_des']=$_POST['des'];
...
<head>
  ...
  <link rel="stylesheet" href="../assets/css/score_report_style.css">
</head>

<body>
    <div class="content">
        <div class="top-title phetsarath f12 center">ສາທາລະນະລັດ ປະຊາທິປະໄຕ ປະຊາຊົນລາວ<br>ສັນຕິພາບ ເອກະລາດ ປະຊາທິປະໄຕ ເອກະພາບ ວັດທະນາຖາວອນ</div>
        <div class="middle-info">
            <div class="company-info phetsarath f12">
                <b>ລັດວິສາຫະກິດ ໄຟຟ້າລາວ</b><br>
                ຝ່າຍຈັດຕັ້ງ ແລະ ບໍລິຫານ<br>
                ສູນຝຶກອົບຮົມ
            </div>
            <div class="company-logo center">
                <svg viewBox="0 0 90 75" height="68">
                    <use xlink:href="#edl_ico"></use>
                </svg>
                <div class="main-title phetsarath f14"><b>ໃບປະເມີນວິຊາການ</b></div>
            </div>
            <div class="doc-info">
                <div class="doc-info-1 phetsarath f12 right">ເລກທີ:________/ຟຟລ-ຝຈບ-ສອຮ</div>
                <div class="doc-info-ຟ phetsarath f12 right">ນະຄອນຫຼວງວຽງຈັນ, ວັນທີ: <?=date('d/m/Y')?></div>
            </div>
        </div>
        <div class="body-content">
            <div class="content-info">
                <div class="phetsarath f12">- ອີງຕາມການສອບເສັງຄັ້ງວັນທີ </div>
                <div class="phetsarath f12"><b>ສູນຝຶກອົບຮົມ</b>, ຝ່າຍຈັດຕັ້ງ ແລະ ບໍລິຫານ ຂໍຖືເປັນກຽດ <?=$has_data?$print_data['doc_des']:''?> ດັ່ງລາຍລະອຽດລຸ່ມນີ້:</div>
            </div>
            <div class="table-content">
                <table>
                    <tr>
                        <th class="phetsarath f12 b center" width="45">ລ/ດ</th>
                        <th class="phetsarath f12 b center">ລະຫັດ<br>ພ/ງ</th>
                        <th class="phetsarath f12 b center">ຊື່ ແລະ ນາມສະກຸນ</th>
                        <th class="phetsarath f12 b center">ລະດັບວິຊາ<br>ສະເພາະ</th>
                        <th class="phetsarath f12 b center">ວິຊາສະເພາະ</th>
                        <th class="phetsarath f12 b center">ພະແນກ</th>
                        <th class="phetsarath f12 b center" width="130">ຝ່າຍ</th>
                        <th class="phetsarath f12 b center" width="56">ຄະແນນ</th>
                        <th class="phetsarath f12 b center">ໝາຍ<br>ເຫດ</th>
                    </tr>
                    <?php
                        if($has_data){
                            ...
                            if($num_row<=8){
                                foreach($data as $item){
                                    ...
                                    ?>
                                    <tr>
                                        <td class="phetsarath f12 center"><?=$index?></td>
                                        <td class="phetsarath f12 center"><?=$item->user_code?></td>
                                        <td class="phetsarath f12 "><?=$item->fullname?></td>
                                        <td class="phetsarath f12 center"><?=$item->degree?></td>
                                        <td class="phetsarath f12 "><?=$item->technical_knowledge?></td>
                                        <td class="phetsarath f12 "><?=$item->dep_name?></td>
                                        <td class="phetsarath f12 "><?=$item->unit_des?></td>
                                        <td class="phetsarath f12 center"><?=$item->point?></td>
                                        <td></td>
                                    </tr>
                                    <?php
                                }
                                ...
                                <div class="phetsarath f12 doc-end-1 <?=($num_row>4)?'new-page':''?>">ດັ່ງນັ້ນ, ຈຶ່ງໄດ້ເຮັດລາຍງານນີ້ມາເພື່ອເປັນຫຼັກຖານຜົນການສອບເສັງ.</div>
                                <div class="phetsarath f12 right">ຮຽນມາດ້ວຍຄວາມນັບຖື,</div>
                                <div class="doc-signature">
                                    <b class="phetsarath f12 left" style="padding-left: 150px;">ຫົວໜ້າສູນຝຶກອົບຮົມ</b>
                                    <b class="phetsarath f12 right" style="padding-right: 100px;">ຄະນະກໍາມະການສອບເສັງ</b>
                                </div>
                                <?php
                            }else{
                                if(($num_row-8)<=14){
                                    ...
                                    <div class="phetsarath f12 doc-end-1 <?=($num_row-8)>9?'new-page':''?>">ດັ່ງນັ້ນ, ຈຶ່ງໄດ້ເຮັດລາຍງານນີ້ມາເພື່ອເປັນຫຼັກຖານຜົນການສອບເສັງ.</div>
                                    <div class="phetsarath f12 right">ຮຽນມາດ້ວຍຄວາມນັບຖື,</div>
                                    <div class="doc-signature">
                                        <b class="phetsarath f12 left" style="padding-left: 150px;">ຫົວໜ້າສູນຝຶກອົບຮົມ</b>
                                        <b class="phetsarath f12 right" style="padding-right: 100px;">ຄະນະກໍາມະການສອບເສັງ</b>
                                    ...
                                    $page_num = ($num_row-8)/14;
                                    $page = 1;
                                    $last_page_num_row = ($num_row-8)%14;
                                    foreach($data as $item){
                                        $index++;
                                        if($index==9 || $index==(9+$page*14)){
                                            if($index!=9) $page++;
                                            ?>
                                                </table><table class="new-page">
                                                <tr>
                                    ...
                                    <div class="phetsarath f12 doc-end-1 <?=($last_page_num_row>9)?'new-page':''?>">ດັ່ງນັ້ນ, ຈຶ່ງໄດ້ເຮັດລາຍງານນີ້ມາເພື່ອເປັນຫຼັກຖານຜົນການສອບເສັງ.</div>
                                    <div class="phetsarath f12 right">ຮຽນມາດ້ວຍຄວາມນັບຖື,</div>
                                    <div class="doc-signature">
                                        <b class="phetsarath f12 left" style="padding-left: 150px;">ຫົວໜ້າສູນຝຶກອົບຮົມ</b>
                                        <b class="phetsarath f12 right" style="padding-right: 100px;">ຄະນະກໍາມະການສອບເສັງ</b>
    ...
    <footer class="phetsarath f9 center">
        ຖະໜົນມິດຕະພາບລາວ-ໄທ, ຕູ້ປນ 309, ບ້ານທົ່ງກາງ ເມືອງສີສັດຕະນາກ ນະຄອນຫຼວງວຽງຈັນ ສປປ ລາວ.<br>
        ໂທ: (856-21) 312791; 351980 Fax: (856-21) 314236 Email: edltc@laopdr.com www.edl-laos.com
    </footer>
</body>
</html>
<script>
...
<div class="hidden-ico">
    ...
    <style type="text/css">
        ...
        .st3{fill:#2E3192;}
        .st4{fill:#FFFFFF;}
        .st5{font-family:'PhetsarathOT';}
        .st6{font-size:21.4835px;}
        .st7{font-size:16.6606px;}
    </style>
    <g id="edl_ico">
        <g>
