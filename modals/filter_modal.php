<div class="modal fade" id="filter" tabindex="-1" role="dialog" aria-labelledby="filter">
    ...
    <div class="modal-content">
            <div class="modal-header" 
                ...
                <h4 class="modal-title phetsarath" id="filter-title">Filter</h4>
            ...
            <form method="POST" action="">
                ...
                <div class="modal-footer" style="justify-content:center;">
                    <button type="submit" name="save_filter" class="cus-btn btn btn-primary btn-icon-text phetsarath none-outline none-select">
                        ບັນທຶກ
