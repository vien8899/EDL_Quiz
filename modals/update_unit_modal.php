<div class="modal fade" id="update_unit" tabindex="-1" role="dialog" aria-labelledby="update_unit">
            ...
            <form method="POST" action="">
                <div class="modal-body">
                    <div id="dep_frame">
                        ...
                        <select class="form-select phetsarath" aria-label="Default select" id="dep_update" name="dep">
                        </select>
                    </div>
                ...
                <div class="modal-footer" style="justify-content:center;">
                    <button type="submit" name="update_unit" class="cus-btn btn btn-primary btn-icon-text phetsarath none-outline none-select">
                        ບັນທຶກ
