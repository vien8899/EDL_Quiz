  ...
  t.defineMode("xml", function (e, n) {
      ...
      if ("<" == r)
        return t.eat("!")
          ? t.eat("[")
            ...
            ? n(i("comment", "-->"))
            : t.match("DOCTYPE", !0, !0)
            ? (t.eatWhile(/[\w\._\-]/), n(l(1)))
            : null
          : t.eat("?")
          ? (t.eatWhile(/[\w\._\-]/), (e.tokenize = i("meta", "?>")), "meta")
          : ((z = t.eat("/") ? "closeTag" : "openTag"),
            (e.tokenize = o),
            "tag bracket");
      if ("&" == r) {
        var a;
    ...
    function u(t, e, n) {
      (this.prev = t.context),
        ...
        (this.startOfLine = n),
        (T.doNotIndent.hasOwnProperty(e) ||
    ...
    function c(t, e) {
      for (var n; ; ) {
        ...
        if (
          ((n = t.context.tagName),
          !T.contextGrabbers.hasOwnProperty(n) ||
            !T.contextGrabbers[n].hasOwnProperty(e))
        )
          return;
        d(t);
      }
    ...
    function m(t, e, n) {
      if ("word" == t) {
        ...
        return (
          n.context &&
            n.context.tagName != r &&
            T.implicitlyClosed.hasOwnProperty(n.context.tagName) &&
            d(n),
    ...
    function h(t, e, n) {
      ...
      if ("endTag" == t || "selfcloseTag" == t) {
        ...
        return (
          ...
          "selfcloseTag" == t || T.autoSelfClosers.hasOwnProperty(r)
            ? c(n, r)
            : (c(n, r), (n.context = new u(n, r, o == n.indented))),
          f
        );
      }
      return (N = "error"), h;
    ...
    var w = e.indentUnit,
      v = n.multilineTagIndentFactor || 1,
      y = n.multilineTagIndentPastTag;
    null == y && (y = !0);
    var z,
      N,
      T = n.htmlMode
    ...
    return {
      ...
      indent: function (e, n, a) {
        ...
        if (e.tokenize != o && e.tokenize != r)
          return a ? a.match(/^(\s*)/)[0].length : 0;
        if (e.tagName)
          return y ? e.tagStart + e.tagName.length + 2 : e.tagStart + w * v;
