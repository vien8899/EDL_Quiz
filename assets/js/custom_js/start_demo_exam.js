function start_exam(_user_id,_quiz_id,_quiz_title,_quiz_time){
    var error = false;
    Swal.fire({
        // title: 'Please',
        ...
        if(error){
            ...
            location.href = "main?page=do_demo_exam";
        }
    });
    Swal.stopTimer();
    var param = {
    ...
    http.open("POST",'controller/demo_exam_controller.php',true);
    ...
    http.onreadystatechange = function(){
        if(this.readyState === XMLHttpRequest.DONE && this.status === 200){
            ...
            if(res.success){
                ...
                sessionStorage.setItem("demo_exam_data",exam_data_encoded);
            }else{
                error = true;
            }
            Swal.resumeTimer();
    ...
    http.send("start_demo_exam="+_param);
}
