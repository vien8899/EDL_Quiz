(function($) {
  ...
  $(function() {
    ...
    if ($("#north-america-chart").length) {
      var areaData = {
        labels: ["ຜ່ານ", "ບໍ່ໄດ້ເສັງ", "ເສັງຕົກ"],
        datasets: [{
            data: [100, 50, 50],
            backgroundColor: [
               "#0d8500","#FFC100", "#b80909",
            ],
      ...
      var areaOptions = {
        ...
        legendCallback: function(chart) { 
          ...
          text.push('<div class="report-chart">');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[0] + '"></div><p class="mb-0 phetsarath">ເສັງຜ່ານ</p></div>');
            text.push('<p class="mb-0">88333</p>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[1] + '"></div><p class="mb-0 phetsarath">ບໍ່ໄດ້ເສັງ</p></div>');
            text.push('<p class="mb-0">66093</p>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[2] + '"></div><p class="mb-0 phetsarath">ເສັງຕົກ</p></div>');
